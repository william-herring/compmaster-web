    ...
    >
      <div className='flex items-center'>
        ...
        <div className='flex flex-col space-y-5 border-l-2 px-8'>
          <Link href="https://www.worldcubeassociation.org/oauth/authorize?client_id=-bokwns3fw-VMbv7QyCdIXOenc79O5hnQqk2hkLq8Cs&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fapi%2Faccount-redirect%3Fredirect%3D%2Fmy-competitions&response_type=code&scope="
